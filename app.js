...
// I've provided you with some very basic markup.  Please select the image element and:
...
const chicken = document.querySelector('img').src = 'https://devsprouthosting.com/images/chicken.jpg';
const chickenName = document.querySelector('img').alt = 'chicken';